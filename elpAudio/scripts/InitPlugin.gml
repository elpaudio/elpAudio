...
do {
    ...
    if string_count('/*(*CREATE*)*/',msg)==1 do { // Create script
        ...
        if string_count('/*',msg)+string_count('*/',msg)<1 _scrBegin+=msg+' '
        file_text_readln(ff)
        msg=file_text_read_string(ff)
    } until string_count('/*(*CREATE_END*)*/',msg)==1

    if string_count('/*(*STEP*)*/',msg)==1 do { // Step script
        if string_count('/*',msg)+string_count('*/',msg)<1 _scrStep+=msg+' '
        file_text_readln(ff)
        msg=file_text_read_string(ff)
    } until string_count('/*(*STEP_END*)*/',msg)==1

    if string_count('/*(*DRAW*)*/',msg)==1 do { // Draw script
        if string_count('/*',msg)+string_count('*/',msg)<1 _scrDraw+=msg+' '
        file_text_readln(ff)
        msg=file_text_read_string(ff)
    } until string_count('/*(*DRAW_END*)*/',msg)==1

    if string_count('/*(*FREE*)*/',msg)==1 do { // Destroy script
        if string_count('/*',msg)+string_count('*/',msg)<1 _scrFree+=msg+' '
        file_text_readln(ff)
        msg=file_text_read_string(ff)
    } until string_count('/*(*FREE_END*)*/',msg)==1
