...
if string_lower(filename_ext(f))=='.asf' return true
if string_lower(filename_ext(f))=='.asx' return true
if string_lower(filename_ext(f))=='.dls' return true
...
if string_lower(filename_ext(f))=='.iff' return true
