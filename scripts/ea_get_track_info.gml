...
else if tag=="ALBUM"/* or tag=="TALB"*/ global.songalbum=string(FMODGetTagData());
else if tag=="YEAR"/* or tag='TYE' */global.songyear=string(FMODGetTagData());
else if tag=="TRACK"/* or tag='TRCK' */global.songnumber=string(FMODGetTagData());
